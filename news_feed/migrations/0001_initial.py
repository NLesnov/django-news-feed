    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(max_length=100000, verbose_name='Текст статьи')),
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='Дата и время создания')),
                ('updated_on', models.DateTimeField(auto_now=True, verbose_name='Дата и время последнего изменения')),
